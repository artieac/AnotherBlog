...
namespace AlwaysMoveForward.AnotherBlog.DataLayer.Repositories
{
    ...
    public class RoleRepository : LINQRepository<Role, RoleDTO>, IRoleRepository
    {
        ...
        protected override RoleDTO GetDTOByDomain(Role targetItem)
        {
            return this.GetDtoById(targetItem.RoleId);
        }
    }
}
