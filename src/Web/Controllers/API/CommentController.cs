...
public class CommentController : BaseApiController
{
    ...
    [Route("/api/Blog/{blogSubFolder}/BlogPost/{postId:int}/Comments")]
    [HttpGet]
    public IList<Comment> GetByPost(string blogSubFolder, int postId)
    {
    ...
    [HttpGet]
    public string GetById(int commentId)
    {
        return "value";
    }

    [Route("/api/Blog/{blogSubFolder}/BlogPost/{postId:int}/Comment")]
    [HttpPost]
